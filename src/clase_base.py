# src/clase_base.py
# Miembros del Grupo: [Aquí los nombres de los miembros de tu grupo]
...
if __name__ == '__main__':
    #  Crear una instancia de Evaluacion directamente generará un error ya que es abstracta
    # evaluacion_base = Evaluacion("Prueba", "2025-05-18", 100)
    print("Clase base Evaluacion definida correctamente")